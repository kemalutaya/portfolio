    ...
    <>
      ...
      <main className="thankyou" aria-label="Thank you page">
        <div className="thankyou__card">
          <span className="thankyou__eyebrow">Message sent</span>
          <h1 className="thankyou__heading">Thanks for getting in touch.</h1>
          <p className="thankyou__body">
            I'll read your message and reply by email, so keep an eye on your inbox and spam folder. If you'd
            rather talk it through, you can{' '}
            <a href="https://cal.com/kem-alutaya" target="_blank" rel="noopener noreferrer">
